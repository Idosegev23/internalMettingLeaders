...
import { Contact, SelectedPerson } from '@/types/form'
import { searchContacts } from '@/lib/csvLoader'
...
export default function PersonSelector({
  ...
  const handleSelectPerson = (contact: Contact) => {
    ...
    if (multiSelect) {
      ...
      const isAlreadySelected = selectedPersons.some(p => p.email === person.email)
